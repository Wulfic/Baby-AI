...
def _find_java(mc_dir: Path, component: str = "java-runtime-delta") -> Path:
    """
...
def _os_matches(os_rule: Dict[str, Any]) -> bool:
...
def _rules_allow(rules: List[Dict[str, Any]]) -> bool:
    """
...
def _build_classpath(mc_dir: Path, version_data: Dict[str, Any]) -> str:
    """
...
def _find_natives_dir(mc_dir: Path, version_id: str) -> str:
    """
